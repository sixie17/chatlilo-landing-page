      ...
      <div className="container mx-auto px-6 space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-start">
            <span className="text-primary font-semibold">{translations.f1.tag}</span>
            <h3 className="text-3xl font-bold text-dark mt-2 mb-4">{translations.f1.title}</h3>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="md:order-1 text-start">
            <span className="text-primary font-semibold">{translations.f2.tag}</span>
            <h3 className="text-3xl font-bold text-dark mt-2 mb-4">{translations.f2.title}</h3>
